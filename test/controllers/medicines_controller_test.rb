...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { count: @medicine.count, manufacturer: @medicine.manufacturer, max_count: @medicine.max_count, name: @medicine.name, notation: @medicine.notation, perm: @medicine.perm, price: @medicine.price }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { count: @medicine.count, manufacturer: @medicine.manufacturer, max_count: @medicine.max_count, name: @medicine.name, notation: @medicine.notation, perm: @medicine.perm, price: @medicine.price }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
